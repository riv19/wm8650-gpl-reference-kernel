/*
 *  mmc_atsmb.h - WMT VT3429 AHB to SD/MMC Bridge driver.
 *
...
#define	MMC_REGULAR_IRQ				IRQ_SDC0
#define	MMC_DMA_IRQ					IRQ_SDC0_DMA
...
/* PIN share switch */
#define GPIO_SD0_PinShare		(1 << 1 | 1 << 2)

/* PMC module reg	*/
//#define PMC_BASE_ADDR 0XD8130000
//#define PMC_SD0_CLK						REG32_PTR(PMC_BASE_ADDR + 0x328)
//#define PMC_PLLB_MULTIPLIER				REG32_PTR(PMC_BASE_ADDR + 0x204)
//#define PMC_OSCNTCLK                                 (27)
