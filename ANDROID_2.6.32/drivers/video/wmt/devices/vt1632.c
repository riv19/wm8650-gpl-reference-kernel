...
int vt1632_check_plugin(int hotplug)
{
	...
	vppif_reg32_write((GPIO_BASE_ADDR+0x300), 0x3<<(VPP_VOINT_NO*2),VPP_VOINT_NO*2,(plugin)?2:3);	// GPIO0 3:rising edge, 2:falling edge
	return plugin;
}
...
static int vt1632_module_init(void)
{	
