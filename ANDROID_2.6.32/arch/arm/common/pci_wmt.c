...
void init_int_usb(void)
{
		...
		pci_config_shadow[INT_USB_EHCI][0][4] = 0xD8007900; /*  0xD8007200; for VT3358 */
		...
		pci_config_shadow[INT_USB_EHCI][0][0xF] = 0x042B;  /*  0x042B; for WM3429   */
		...
		pci_config_shadow[INT_USB_UHCI][0][8] = 0xD8007B01; /*  0xD8007401; for VT3358 */
		...
		pci_config_shadow[INT_USB_UHCI][0][0xF] = 0x012B;   /*  0x012B; for WM3429 uhci */
		...
		pci_config_shadow[INT_USB_UHCI2][0][8] = 0xD8008D01; /*  0xD8007401; for VT3358 */
		...
		pci_config_shadow[INT_USB_UHCI2][0][0xF] = 0x012B;   /*  0x012B; for WM3429 uhci */
