...
#define IDLE_REQ_ADDR       (__PMC_BASE + 0x0008)
...
#define PMAUD_ADDR      (__PMC_BASE + 0x0220)     /* PLL Audio Control Register */
...
#define PMDSPD_ADDR     (__PMC_BASE + 0x0308)
#define PMDSPH_ADDR     (__PMC_BASE + 0x0309)
#define PMMC_ADDR       (__PMC_BASE + 0x0310)

#define PMSF_ADDR       (__PMC_BASE + 0x0314)     /* SF */
#define PMSFH_ADDR      (__PMC_BASE + 0x0315)
#define PMAPB1_ADDR    (__PMC_BASE + 0x0318)      /* APB 1 */
#define PMAPB1H_ADDR   (__PMC_BASE + 0x0319)
#define PMAPB0_ADDR    (__PMC_BASE + 0x0320)      /* APB 0 */
#define PMAPB0H_ADDR   (__PMC_BASE + 0x0321)
#define PMSDMMC_ADDR    (__PMC_BASE + 0x0328)     /* SD/MMC 0 */
#define PMSDMMCH_ADDR   (__PMC_BASE + 0x0329)
#define PMMSP_ADDR    (__PMC_BASE + 0x032C)       /* MS Pro */
#define PMMSPH_ADDR   (__PMC_BASE + 0x032D)
#define PMNAND_ADDR     (__PMC_BASE + 0x0330)     /* NAND */
#define PMNANDH_ADDR    (__PMC_BASE + 0x0331)
#define PMXD_ADDR      (__PMC_BASE + 0x0334)      /* XD */
#define PMXDH_ADDR	    (__PMC_BASE + 0x0335)
#define PMLCD_ADDR      (__PMC_BASE + 0x0338)     /* LCD */
#define PMLCDH_ADDR	    (__PMC_BASE + 0x0339)
#define PMSPI_ADDR      (__PMC_BASE + 0x033C)     /* SPI 0 */
#define PMSPIH_ADDR	    (__PMC_BASE + 0x033D)
#define PMSDMMC1_ADDR    (__PMC_BASE + 0x0340)    /* SD/MMC 1 */
#define PMSDMMC1H_ADDR   (__PMC_BASE + 0x0341)
#define PMPWM_ADDR      (__PMC_BASE + 0x0348)     /* PWM */
#define PMPWMH_ADDR	    (__PMC_BASE + 0x0349)
...
#define PMIDE100_ADDR	    (__PMC_BASE + 0x0360) /* PATA */
#define PMIDE100H_ADDR	  (__PMC_BASE + 0x0361)
#define PMIDE133_ADDR	    (__PMC_BASE + 0x0364) /* PATA 133MHz */
#define PMIDE133H_ADDR	  (__PMC_BASE + 0x0365)
#define PMI2C0_ADDR	    (__PMC_BASE + 0x036C)     /* I2CM */
#define PMI2C0H_ADDR	  (__PMC_BASE + 0x036D)
...
#define PMDSPD_REG			(REG8_PTR(PMDSPD_ADDR))
#define PMDSPH_REG			(REG8_PTR(PMDSPH_ADDR))
...
#define PMAPB0_REG			(REG8_PTR(PMAPB1_ADDR))
#define PMAPB0H_REG			(REG8_PTR(PMAPB1H_ADDR))
...
#define PMDSPD_VAL			(REG8_VAL(PMDSPD_ADDR))
#define PMDSPH_VAL			(REG8_VAL(PMDSPH_ADDR))
...
#define PMAPB0_VAL			(REG8_VAL(PMMAPB0_ADDR))
#define PMAPB0H_VAL			(REG8_VAL(PMMAPB0H_ADDR))
