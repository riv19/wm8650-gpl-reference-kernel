...
/* vt34xx spi controller configure parameters */
...
/**
 *struct vt34xx_spi_hw - vt34xx spi controller config information
...
/**
 * struct vt34xx_spi_slave - vt34xx spi slave config infomatin
 * @dma_en:        transfer use dma or not 
 * @bits_per_word: bit_per_word this chip only can work with
 */
struct vt34xx_spi_slave {
    u8  dma_en;
    u8  bits_per_word;
};

/**
 *struct vt34xx_spi  - vt34xx spi controller driver data
 */
struct vt34xx_spi {
    struct platform_device *pdev;  /* Driver model hookup     */
    struct spi_master *master;     /* SPI framework hookup    */
    void __iomem *regs_base;       /* SPI regs base of vt34xx */
    ...
    struct vt34xx_spi_dma *spi_dma_info;
};


struct vt34xx_spi_dma {
    unsigned int  rx_ch;
    unsigned int  tx_ch;
...
#define PMC_REG_BASE            0xD8130000
